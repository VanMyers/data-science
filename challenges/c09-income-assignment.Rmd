...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   Counties with higher populations tend to have a lower `SE`. This trend may exist because $SE = \frac{\sigma}{\sqrt{n}}$ meaning a higher population will reduce the `SE` if the standard deviation does not also change.

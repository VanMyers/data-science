...
- Very few diamonds above 3 carats are sold
- Diamonds as small as 1 carat are as expensive as the largest diamonds
- There is a positive correlation between diamond carat and price
- Diamonds carat is most commonly an integer or just above
...
- Cut accounts for some price variation among similar size diamonds
- Some diamonds of similar size sell at higher prices despite worse cuts
- Few of the largest diamonds are of the most desired cuts

...
`install.packages()` is for using packages on your local machine and
only needs to be done once. `library()` is like an include statement
that should be at the beginning of any notebook where you are using the
packages. We will likely use tidyverse for every notebook.

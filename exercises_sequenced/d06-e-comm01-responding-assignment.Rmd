...
-   Is the bolded response **active** or **passive**? Why? Active. It reponds to and builds on the observation that there are no axis
-   Is the bolded response **constructive** or **destructive**? Why? Constructive. It acknowledges the observation positively and respectfully resolves their question.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt? smart/apreciated
...
-   Is the bolded response **active** or **passive**? Why? Passive. It does not engage with the question
-   Is the bolded response **constructive** or **destructive**? Why? Constructive. It includes positive affirmation.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt? better than that version but blown off.
...
-   Is the bolded response **active** or **passive**? Why? Passive. It does not relate to the content of the graph or presentation.
-   Is the bolded response **constructive** or **destructive**? Why? I would lean destructive because it feels like there is an implicit suggestion that the field is immoral and the presentation is therefore less valuable.

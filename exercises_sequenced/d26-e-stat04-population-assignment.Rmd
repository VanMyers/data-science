...
-   The shape is symmetric and appears similar to a normal distribution just with a different mean.
...
-   Which setting---q2.1 or q2.2---will tend to produce more accurate estimates? Why?
    -   q.21 will tend to produce more accurate estimates because the standard error is lower.
...
-   How close is your estimate `se_sample` to the true `se_q2.1`? `se_sample = 0.775`
-   What accounts for the difference between these values? The stadard deviation of the sample is not the standard deviation of the population.

...
-   the length (x) and width (y) have nearly identical distributions but
    the max width is far greater
-   the height (z) of diamonds tends to be lower than either length or
    width
-   variables with discrete categories only list count of each value
-   Price is a very skewed distribution
-   Fewer low quality diamonds are sold (in terms of both cut and
    clarity
-   Few diamonds are sold with either the best or worst color
